...
for t in range(192):
    conversionSchedule_set.append(0.000)

    storageSchedule_set.append(0.000)

    pumpSchedule_set.append(0.000)

    chpDH_Schedule_set.append(0.000)
    ...
    hpSchedule9_set.append(0.000)
    hpSchedule10_set.append(0.000)
    hpSchedule11_set.append(0.000)
    hpSchedule12_set.append(0.000)
...
wb.save('Results/SingleDomainArbitrary.xlsx')
print("Results are available in 'Results' folder", "'SingleDomainArbitrary.xlsx' file")