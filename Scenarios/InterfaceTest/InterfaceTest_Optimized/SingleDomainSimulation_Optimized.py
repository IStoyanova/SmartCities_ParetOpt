from Scenarios.OptimizationModels.OptModelsFor_InterfaceTest.SingleDomainOptimizationModel_E import *
from Scenarios.OptimizationModels.OptModelsFor_InterfaceTest.SingleDomainOptimizationModel_W import *
from Scenarios.OptimizationModels.OptModelsFor_InterfaceTest.SingleDomainOptimizationModel_G import *
...
for t in range(T):
    conversionSchedule_set.append(0.0)

    storageSchedule_set.append(0.0)

    pumpSchedule_set.append(0.0)

    chpDH_Schedule_set.append(0.0)
...
wb.save('Results\SingleDomainOperation.xlsx')
print("Results are available in 'Results' folder", "'SingleDomainOperation.xlsx' file")
