from Scenarios.OptimizationModels.OptModelsFor_InterfaceTest.OptimizationModel_EGTW import *
...
wb.save('Results\CrossDomainOperation.xlsx')
print("Results are available in 'Results' folder", "'CrossDomainOperation.xlsx'")
