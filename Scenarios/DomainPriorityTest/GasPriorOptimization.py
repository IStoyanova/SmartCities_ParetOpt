from Scenarios.OptimizationModels.OptModelsFor_DomainPriorityTest.OptimizationModel_GE import *
...
wb.save('Results\SingleDomainOptimization_GasPrior.xlsx')
print("Results are available in 'Results' folder", "'SingleDomainOptimization_GasPrior.xlsx' file")
