from Scenarios.OptimizationModels.OptModelsFor_DomainPriorityTest.OptimizationModel_EGTW import *
...
wb.save('Results\CrossDomainOptimization.xlsx')
print("Results are available in 'Results' folder", "'CrossDomainOptimization.xlsx' file")
