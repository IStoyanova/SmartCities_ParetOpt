...
def run_test():
    ...
    flowTemperature = np.array([40]*timer.timestepsHorizon)
    ...
    schedule = np.random.randint(2, size=192)
    print('scheduleSize:',len(schedule))

    heater.setResults(flowTemperature,schedule)
