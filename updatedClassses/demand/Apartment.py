...
class Apartment(object):
    ...
    def __init__(self, environment, net_floor_area=None, occupancy=None):
        ...
        #TODO: Add water load profiles
        # Water load profiles currently follow the electrical load
        self.demandWater= ElecDemand.ElectricalDemand(environment,
                                                    method=0,
                                                    annualDemand=0)
    ...
    def get_water_demand_curve(self, current_values=True):
        """
        Returns net water demand curve of apartment
        Parameters
        ----------
        currentValues : bool, optional
            Return the current values (True) or return values for all time
        ...
        Returns
        -------
        water_demand_curve : array-like
            Water demand curve --> liter
        """

        """
        Water demand curve follows electrical demand
        Returns water consumption in m3/s
        Typical annual water consumption for three member household is 134 m3
        Typical annual power consumption is 3000kWh
        """
        return self.demandWater.get_power(currentValues=current_values)*134/(3000*1000*3600)
