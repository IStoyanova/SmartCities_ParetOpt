...
class GasPipe(TransportMedium):
    def __init__(self,environment,length=10,diameter=0.1,rho=0.8,lamda=0.03):
        ...
        super(GasPipe, self).__init__(environment)
        self._kind = "gaspipe"
    ...
    def getResults(self, currentValues=True):
        ...
        flowQuantity : array_like
            Gas volume flow rate through the Pipe
    ...
    def setResults(self, vRate):
        """
        Save volume flow rate of the gas and pressure drop.
        """
